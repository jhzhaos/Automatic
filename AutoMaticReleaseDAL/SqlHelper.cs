...
namespace AutoMaticReleaseDAL
{    /// <summary>
    /// SqlHelper操作类
    /// </summary>
    public sealed partial class SqlHelper
    {    
        static string serviceConnectionString = "data source=.;initial catalog=AutomaticRelease;persist security info=True;user id=sa;password=welcome;MultipleActiveResultSets=True;App=EntityFramework";
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        public static string ConnectionString =serviceConnectionString;
        /// <summary>
        /// 批量操作每批次记录数
        /// </summary>
